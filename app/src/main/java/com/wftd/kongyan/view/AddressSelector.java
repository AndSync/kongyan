...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        TextEmptyColor = getResources().getColor(R.color.white);
        TextSelectedColor = getResources().getColor(R.color.white);
        listTextNormalColor = getResources().getColor(R.color.white);
        listTextSelectedColor = getResources().getColor(R.color.white);
        removeAllViews();
    ...
    private class Line extends LinearLayout {
        ...
        public void setIndex(int index) {
            ...
            this.nowIndex = index;
            ObjectAnimator animator = ObjectAnimator.ofFloat(indicator, "translationX", indicator.getTranslationX(),
                (nowIndex - oldIndex) * onceWidth);
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            if (listItemIcon != -1) holder.img.setImageResource(listItemIcon);
            if (listTextSize != -1) holder.tv.setTextSize(listTextSize);
